...
const Table = ({
            ...
            return (
                <div className="flex justify-end gap-2.5">
                    ...
                    {onDelete && (data?.disableDelete !== 1) && (
                        <button className="border border-red-700 text-red-700 p-2 rounded hover:bg-red-700 hover:text-white focus:shadow-none"
    ...
    return (
        <>
            <div className={`w-full bg-white ${shadow ? 'shadow-lg' : ''} rounded-lg mb-4`}>
                {noHeader || (
